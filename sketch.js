...
function setup() {
 ...
 bgsprite2=createSprite(700,300,1400,400)
...
dangerguy4.scale=0.3
   ...
   dangerguy9=createSprite(1000, random(0,270), 50, 50);
    dangerguy9.addImage(dangerguy2img)
    dangerguy9.scale = 0.57
    dangerguy9.velocityX=-5
    dangerguy9.velocityY=-1
    dangerguy9.visible=false
...
function draw() {
  ...
  dangerguy9.bounceOff(wall1);
  dangerguy9.bounceOff(wall2);
  dangerguy9.bounceOff(wall3);
  dangerguy9.bounceOff(wall4);
...
if(keyDown(RIGHT_ARROW)){
  ...
  if(keyDown('w')){
    ...
    dangerguy9.visible=true
  }
  background(0)
    textSize(25)
    fill("yellow")
    text("Dangermouse ", 10,300)
    text("power",10,380)
    text("has been enabled",10,460)


    if(dangermouse.isTouching(dangerguy9)){
      dangerguy9.destroy()
      bgsprite2.visible=false
      textSize(40)
      fill("purple")
      text("You Saved LONDON city,You are a hero",600,350)
      sleep()
    }
